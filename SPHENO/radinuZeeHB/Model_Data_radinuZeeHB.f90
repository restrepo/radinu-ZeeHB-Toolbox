...
Real(dp) :: ratioFd(2,3),ratioFe(2,3),ratioFu(2,3),ratioHm(2,3),ratioVWp(2)

Complex(dp) :: ratioGG(2),ratioPP(2)

Real(dp) :: ratioPFd(1,3),ratioPFe(1,3),ratioPFu(1,3),ratioPHm(1,3),ratioPVWp

Complex(dp) :: ratioPGG,ratioPPP

Real(dp) :: gForTadpoles(162)
...
Real(dp) :: rHB_P_P_Fv(1,3),rHB_P_S_Fv(1,3),rHB_S_S_Fv(2,3),rHB_S_P_Fv(2,3)
...
End Module Model_Data_radinuZeeHB